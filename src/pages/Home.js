...
function Home(props) {
  ...
  const [bedanktModalOpen, setBedanktModalOpen] = useState(true);
    ...
    <div className="App">
      ...
      <div className="ONntwk__main">
        ...
        {consuModalOpen &&
          <>
            {/* <div className="ONntwk__lightblueWelcomeCoverAbsolute"> */}
              {/* donderdag///hier in comment geplaatst */}
            {/* <div setOpenBendanktModal={setBedanktModalOpen} setOpenModal={setModalOpen} className="ONntwk__bluecover ">
              <Bedankt setOpenBedanktModal={setBedanktModalOpen} setOpenModal={setModalOpen} />
            </div> */}
          </>
        }
      </div>
